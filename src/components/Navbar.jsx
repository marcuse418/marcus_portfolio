            ...
            <div className="max-w-5x1 mx-auto px-4">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <a href="#projects" className="text-black hover:text-gray-400 transition-colors duration-300">
                            Projects 
                        </a>

                        <a href="#about" className="text-black hover:text-gray-400 transition-colors duration-300">
                            About 
                        </a>
