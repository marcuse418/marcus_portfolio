        ...
        <div className="glass-effect bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col h-full">
            ...
            {githubUrl && (
                <a 
                    ...
                    className="inline-flex items-center px-3 py-1.5 bg-gray-800 text-white rounded-full hover:bg-gray-700 transition-colors duration-300 mt-auto w-fit shadow-lg hover:shadow-xl"
                >
                    <svg 
