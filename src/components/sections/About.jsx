            ...
            <RevealOnScroll>
                <div className="text-center z-10 px-4 max-w-4xl mx-auto">
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        <a 
                            href="tel:+61433789333" 
                            className="flex items-center gap-2 px-6 py-3 border border-black/20 bg-white text-black rounded-full hover:bg-gray-200/100 transition-all duration-300 shadow-lg hover:shadow-xl"
                        >
                        ...
                        <a 
                            href="mailto:marcusfelliott@mac.com" 
                            className="flex items-center gap-2 px-6 py-3 border border-black/20 bg-white text-black rounded-full hover:bg-gray-200/100 transition-all duration-300 shadow-lg hover:shadow-xl"
                        >
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a 
                            href="https://www.linkedin.com/in/marcus-elliott/" 
                            target="_blank" 
                        ...
                        <a 
                            href="https://github.com/marcuse418" 
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-6 py-3 border border-black/20 bg-white text-black rounded-full hover:bg-gray-200/100 transition-all duration-300 shadow-lg hover:shadow-xl"
                        >
